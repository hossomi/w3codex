...
RACES = {'Human', 'Orc', 'Undead', 'Night Elf'}
RACE_HUMAN = RACES[1]
RACE_ORC = RACES[2]
RACE_UNDEAD = RACES[3]
RACE_NIGHT_ELF = RACES[4]

PLAYER_TYPES = {'User', 'Computer', 'Neutral', 'Rescuable'}
